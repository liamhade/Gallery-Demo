  ...
  function GalleriesDropdown() {
    return (
      <Paper
        sx={{
          position: "absolute",
          top: galleriesButtonRef.current
            ? galleriesButtonRef.current.offsetTop +
              galleriesButtonRef.current.clientHeight
            : 0,
          left: galleriesButtonRef.current
            ? galleriesButtonRef.current.offsetLeft
            : 0,
        }}
        onMouseEnter={() => {
...
const LogoLink = () => {
  return (
    <a
      ...
      target="_blank"
    >
      <Image src={Logo} alt="comedyuo-logo" id="comedyuo-logo" />
    </a>
  );
};
